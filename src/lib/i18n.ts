...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    "about.feature_portfolio_desc": "Track your investments with real-time prices, sector allocation, and AI-powered SŪQAI Score insights.",
  ...
  ar: {
    ...
    "about.feature_portfolio_desc": "تتبّع استثماراتك مع أسعار فورية وتوزيع القطاعات ورؤى تقييم SŪQAI الذكية.",
